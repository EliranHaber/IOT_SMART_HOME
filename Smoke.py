...
SMOKE_topic = 'pr/home/5976397/smoke'
...
class Mqtt_client():
    ...
    def connect_to(self):
        self.client = mqtt.Client(client_id="IOT_pub_322710534", clean_session=True)
...
class ConnectionDock(QDockWidget):
    ...
    def __init__(self, mc):
        ...
        self.ePublisherTopic.setText(SMOKE_topic)

        self.SmokeLevel = QLineEdit()
        self.SmokeLevel.setText('')

        formLayout = QFormLayout()
        formLayout.addRow("Turn On/Off", self.eConnectbtn)
        formLayout.addRow("Pub topic", self.ePublisherTopic)
        formLayout.addRow("Smoke Level(%)", self.SmokeLevel)
...
class MainWindow(QMainWindow):
    ...
    def __init__(self, parent=None):
        ...
        self.setWindowTitle('Smoke Detector')
    ...
    def update_data(self):
        print('Next update')
        smoke_level = random.randint(0, 90)  # Smoke level simulation
        current_data = 'Smoke Level: ' + str(smoke_level)
        self.connectionDock.SmokeLevel.setText(str(smoke_level))
        self.mc.publish_to(SMOKE_topic, current_data)
